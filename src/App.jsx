  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <RadarChart data={data} margin={{ top: 10, right: 30, bottom: 10, left: 30 }}>
        ...
        <PolarAngleAxis
          dataKey="category"
          tick={{ fill: BRAND.light, fontSize: 11, fontFamily: "'DM Mono', monospace" }}
        />
        <Radar
          name="Score"
          dataKey="score"
...
export default function App() {
  ...
  const progressBar = {
    height: 2, background: BRAND.border, flex: 1, margin: "0 32px", borderRadius: 1,
  };
  const progressFill = {
    height: "100%", background: BRAND.accent,
    width: `${progress}%`, transition: "width 0.4s ease", borderRadius: 1,
  };
  ...
  if (phase === "intro") return (
    <div style={shell}>
      <div style={topBar}>
        <span style={logo}>Intralytics</span>
        <span style={{ fontSize: 11, color: BRAND.muted, letterSpacing: "0.1em" }}>AI GOVERNANCE READINESS</span>
      </div>
      <div style={{ ...content, display: "flex", flexDirection: "column", justifyContent: "center", minHeight: "100vh", paddingTop: 80 }}>
    ...
    return (
      <div style={shell}>
        <div style={topBar}>
          ...
          <span style={{ fontSize: 11, color: BRAND.accent, letterSpacing: "0.1em" }}>COMPLETE</span>
        </div>
        <div style={content}>
  ...
  return (
    <div style={shell}>
      <div style={topBar}>
        ...
        <span style={{ fontSize: 11, color: BRAND.muted, letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
          {answered}/{total}
        </span>
      </div>
